...
const holidayEvents = require(`./api/nyc/brooklyn/holiday/holidayEvents`);
...
// Bronx
// const foodBx = require(`./api/nyc/bronx/food/foodPantries`);
...
// Staten Island
// const foodSI = require(`./api/nyc/statenisland/foodPantries`);
...
// // Queens
// const foodQn = require(`./api/nyc/queens/foodPantries`);
...
// app.get(`/api/v1/nyc/bronx/foodPantries`, (req, res) => {
//   foodBx().then(msgs => res.send(msgs));
// });
...
app.get(`/api/v1/nyc/brooklyn/holiday`, (req, res) => {
  holidayEvents().then(msgs => res.send(msgs));
});
...
//   shelterMn().then(msgs => res.send(msgs));
// });

// app.get(`/api/v1/nyc/manhattan/shelterMore`, (req, res) => {
//   shelterMoreMn().then(msgs => res.send(msgs));
// });
